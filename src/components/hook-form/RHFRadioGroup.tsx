          ...
          >
            {options.map((option) => (
              <FormItem
                ...
                className={cn(
                  "flex flex-grow items-center focus:bg-grey-300 relative  border-gray-600  justify-center    basis-full  cursor-pointer hover:bg-grey-50 text-center ",
                  !withoutIcon && "py-[10px] px-4 ",
                
                  currentValue === option.id && selectFeedback === "ghost" && "bg-grey-600",
                ...
                >
                  <FormLabel
                    ...
                    className={cn(
                      ...
                      currentValue === option.id && "bg-[#848484] border border-primary rounded-xl",
